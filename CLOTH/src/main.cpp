...
int main()
{
    ...
    Shader illumination_shader = Shader("src\\shaders\\06_illumination.vert", "src\\shaders\\06_illumination.frag");
    Shader force_shader = Shader("src\\shaders\\07_force.vert", "src\\shaders\\07_force.frag");
    Shader fullColor_shader = Shader("src\\shaders\\00_basic.vert", "src\\shaders\\01_fullcolor.frag");
    Shader normal_shader = Shader("src\\shaders\\03_normal2color.vert", "src\\shaders\\03_normal2color.frag");
    Shader color_shader = Shader("src\\shaders\\09_color_GGX.vert", "src\\shaders\\09_color_GGX.frag");
    Shader force_BlinnPhong_shader = Shader("src\\shaders\\08_force_Phong.vert", "src\\shaders\\08_force_Phong.frag");
